...
{
    public partial class KpiApp : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KpiForms", x => x.Id);
                    table.ForeignKey(
                        name: "FK_KpiForms_KpiResults_KpiResultId",
                        column: x => x.KpiResultId,
                        principalTable: "KpiResults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_KpiForms_Kpis_KpiId",
                        column: x => x.KpiId,
                        principalTable: "Kpis",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KpiForms_KpiId",
                table: "KpiForms",
                column: "KpiId");

            migrationBuilder.CreateIndex(
                name: "IX_KpiForms_KpiResultId",
                table: "KpiForms",
                column: "KpiResultId");

            migrationBuilder.CreateIndex(
                name: "IX_KpiResults_EmployeeId",
                table: "KpiResults",
                column: "EmployeeId");
